...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "Z4Uwv28WrAlIo95vyqOILY4b/s3svTlWOe3IYjFto+w="));
    ...
    //create ecs services
    // fargate service type of ecs service
    private FargateService createFargateService(String id,
                                                String imageName,
                                                List<Integer> ports,
                                                DatabaseInstance db,
                                                Map<String, String> additionalEnvVars) {
        //blueprint to run container
        ...
        if(db != null){
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD",
                    Objects.requireNonNull(db.getSecret()).secretValueFromJson("123456").toString());
    ...
    // create load balance app gateway
